  ...
  return (
    <div className='bg-white p-4 box-shadow-primary add-review'>
      <form onSubmit={handleSubmit} noValidate>
        <h3 className='mb-3'>Сэтгэгдэл бичих</h3>
        <Row>
          <Col xs='12' md='12'>
            <Input
              type={'text'}
              ...
              label={'Гарчиг'}
              name={'title'}
              placeholder={'Энд Сэтгэгдлийн гарчигаа бичээрэй'}
          ...
          <Col xs='12' md='12'>
            <SelectOption
              ...
              label={'Та энэ бүтээгдэхүүнийг бусдад санал болгох уу?'}
              name={'isRecommended'}
        ...
        <div className='mt-4'>
          <Button type='submit' text='Сэтгэгдэл үлдээх' />
        </div>
      </form>
    </div>
  );
