  ...
  render() {
    ...
    return (
      <div className='sell'>
        ...
        <h3 className='text-uppercase'>Арьс Гоо-той хамтран ажиллаарай!</h3>
        <hr />
        <Row>
            ...
            <Row>
              <Col xs='12' className='order-2 order-md-1 text-md-center mb-3'>
                <div className='agreement-banner-text'>
                  <h3>Өөрийн бүтээгдэхүүнээ Арьс Гоо-д зармаар байна уу?</h3>
                  <h5>Арьс Гоо-той хамтран ажиллах</h5>
